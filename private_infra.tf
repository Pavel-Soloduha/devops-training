...
//    var.common_tags,
//    map(
//      "Name", "Rundeck-${element(data.aws_availability_zones.zones.names, count.index)}",
//      "app-type", "rundeck",
//      "AZ", element(data.aws_availability_zones.zones.names, 0)
//    )
//  )
//}
//
//resource "aws_route53_record" "rundeck-route53" {
//  zone_id = data.aws_route53_zone.test_zone.id
//  name    = "rundeck-solodukha.test.coherentprojects.net"
//  type    = "CNAME"
//  ttl     = "60"
//  records = [aws_lb.alb.dns_name]
//}
//
//resource "aws_lb_listener_rule" "rundeck_lb_rule" {
//  listener_arn = aws_lb_listener.alb-default-listener.arn
//  action {
//    type             = "forward"
//    target_group_arn = aws_lb_target_group.rundeck_target.arn
//  }
//  condition {
//    field  = "host-header"
//    values = ["rundeck-solodukha.*"]
//  }
//}
//
//resource "aws_lb_target_group" "rundeck_target" {
//  name     = "solodukha-rundeck-target"
//  port     = 80
//  protocol = "HTTP"
//  vpc_id   = aws_vpc.vpc.id
//
...
//}
//
//resource "aws_lb_target_group_attachment" "rundeck_target_attachment" {
//  count            = var.infra_subnets_count
//  target_group_arn = aws_lb_target_group.rundeck_target.arn
